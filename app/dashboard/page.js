...
const Logo = ({ size = 32 }) => (
  <svg width={size} height={size} viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <rect x="15" y="30" width="70" height="50" rx="10" fill="url(#sp1)"/>
    <circle cx="50" cy="55" r="18" fill="#0e7490" opacity="0.8"/>
    <circle cx="50" cy="55" r="13" fill="#164e63"/>
    <circle cx="50" cy="55" r="8" fill="#0891b2" opacity="0.9"/>
    <circle cx="46" cy="51" r="3" fill="white" opacity="0.4"/>
    <rect x="38" y="20" width="24" height="12" rx="4" fill="url(#sp1)"/>
    <rect x="68" y="33" width="10" height="7" rx="3" fill="white" opacity="0.5"/>
  </svg>
)
  ...
  const Sidebar = () => (
    <div style={{width:220,background:'linear-gradient(180deg,#0a0f2e 0%,#0f172a 100%)',display:'flex',flexDirection:'column',padding:'20px 12px',height:'100vh',position:'sticky',top:0,flexShrink:0,overflowX:'hidden'}}>
      ...
      <div style={{marginTop:'auto',borderTop:'1px solid rgba(255,255,255,0.06)',paddingTop:14}}>
        ...
        <button onClick={() => { document.cookie='sna_token=;max-age=0'; document.cookie='sna_user=;max-age=0'; router.push('/login') }}
